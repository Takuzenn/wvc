...
const data = [
  {
    id: 1,
    tabTitle: 'Worshops',
    title: `We will have the best weekly Entreprenerial Workshops`,
    description: ``,
  ...
  {
    id: 2,
    tabTitle: 'Venture Incumbators',
    title: `We will incubate your ideas and boost your company`,
    description: `We boost your companies through a series of practices, it is a great chance for you to take your business to the next level by
    learning entrepreneurial skills and connecting to investors, developers and entrepreneurs`,
    // moreLink: '#explore-more',
    image: tabImage1,
    list: [
